...
export function ProveedoresTab({
  desde, setDesde, hasta, setHasta, proveedores, loadingProveedores,
  proveedorAbierto, setProveedorAbierto, proveedorBusqueda, setProveedorBusqueda,
  proveedorSort, setProveedorSort,
