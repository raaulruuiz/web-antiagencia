...
export default function HomeV2() {
  useEffect(() => {
    ...
    style.id = "mailerlite-css-homev2";
    ...
    script.id = "mailerlite-script-homev2";
    document.body.appendChild(script);

    return () => {
      const css = document.getElementById("mailerlite-css-homev2");
      if (css && css.parentNode) css.parentNode.removeChild(css);
      const scr = document.getElementById("mailerlite-script-homev2");
