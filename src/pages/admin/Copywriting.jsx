...
export default function Copywriting() {
  const [order, setOrder] = useState(loadOrder);                  // [id, id, ...]
  const [activeId, setActiveId] = useState(() => loadOrder()[0]); // default = first in order
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl">
      ...
      {/* Structure tabs — labels reflect current order */}
