...
const ALL_NAV = [
  ...
  { to: '/admin/biblioteca',       label: 'Biblioteca',       icon: '📚', page: 'biblioteca',       desc: 'Gestiona la Anti-Biblioteca pública' },
  ...
  { to: '/admin/calendly',         label: 'Calendly',         icon: '📅', page: 'calendly',         desc: 'Dashboard de reuniones y tipos de reunión' },
