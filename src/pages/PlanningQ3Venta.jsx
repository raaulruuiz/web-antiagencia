        ...
        <div className="w-full max-w-5xl">
          <div className="bg-white shadow-xl rounded-sm px-8 md:px-16 py-12" style={{ fontFamily: "'Georgia', serif" }}>
            <div className="text-gray-800 text-base leading-relaxed" style={{ lineHeight: '2' }}>
              ...
              <h1 className="text-2xl md:text-4xl text-center text-gray-900 leading-tight mb-4" style={{ fontWeight: 400 }}>HAY ALGO QUE DEBES HACER SIEMPRE…&nbsp;</h1>
              <h1 className="text-2xl md:text-4xl text-center text-gray-900 leading-tight mb-4" style={{ fontWeight: 400 }}>Y QUE NO TE PUEDES SALTAR…&nbsp;</h1>
              <h1 className="text-2xl md:text-4xl text-center text-gray-900 leading-tight mb-4" style={{ fontWeight: 400 }}>SI QUIERES QUE TE VAYA BIEN EN TU TIENDA…</h1>
              <p>&nbsp;</p>
