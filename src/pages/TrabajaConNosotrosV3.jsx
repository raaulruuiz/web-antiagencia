        ...
        <div className="w-full max-w-5xl">
          <div className="bg-white shadow-xl rounded-sm px-8 md:px-16 py-12" style={{ fontFamily: "'Georgia', serif" }}>
            <div className="text-gray-800 text-base leading-relaxed" style={{ lineHeight: '2' }}>
              ...
              {/* Historia */}
              <p>Lo que te voy a contar ahora sobre cierto pintor alemán que todos conocemos y cuyo nombre empieza por H y termina por itler, te va a dejar dándole vueltas a la cabeza y, probablemente, transforme tu marca y la vuelva mucho más atractiva y rentable.</p>
              <p>&nbsp;</p>
              <p>Es una historia muy breve y fabulosa que, solo la historia, ya te dará un aprendizaje clave que podrás implementar hoy mismo. Vamos a ello.</p>
              <p><br /><br /><br /></p>
