...
export default function HablemosDeEmprender() {
  useEffect(() => {
    const style = document.createElement("style");
    style.innerHTML = mailerLiteCSS;
    style.id = "mailerlite-css-nicolas";
    document.head.appendChild(style);

    window.ml_webform_success_42311315 = function () {
      window.umami?.track('registro-hablemos-de-emprender');
      try {
    ...
    script.id = "mailerlite-script-nicolas";
    document.body.appendChild(script);

    return () => {
      const css = document.getElementById("mailerlite-css-nicolas");
      if (css && css.parentNode) css.parentNode.removeChild(css);
      const s = document.getElementById("mailerlite-script-nicolas");
  ...
  return (
    <>
    <Helmet>
      <title>Hablemos de Emprender × Antiagencia — Email marketing para ecommerce</title>
      <meta name="description" content="Colaboración especial con el podcast Hablemos de Emprender de Nicolás. Todo lo que necesitas saber sobre email marketing para escalar tu tienda online." />
    </Helmet>
      ...
      <div className="flex-1 flex justify-center px-4 py-12 md:py-20">
        <div className="w-full max-w-2xl">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-center text-gray-900 leading-tight mb-6">
            Si vienes del podcast de Nicolás, Hablemos de Emprender, esto es para ti...
          </h1>
