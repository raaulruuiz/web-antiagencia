        ...
        <div className="w-full max-w-3xl">
          <div className="bg-white shadow-xl rounded-sm px-8 md:px-16 py-12" style={{ fontFamily: "'Georgia', serif" }}>
            <div className="text-gray-800 text-base leading-relaxed">
              ...
              <p className="mb-6">Y si hace falta reunirse, pues nos reunimos.</p>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-3">
                ...
                <li>Lo primero que debemos evitar a la hora de mandar un mail.</li>
                <li>Cómo automatizar con IH (Inteligencia Humana) tus mensajes para que resuenen y vendan más.</li>
                <li>Lo que aprendimos de la historia para contar historias que hará que tu tienda haga historia.</li>
                <li>Cómo hacer que tus clientes te vuelvan a comprar en cuestión de días gracias a la estrategia del ratoncito pérez.</li>
                <li>Cómo manejar los anuncios como un trader criptobro, que lo hace mejor que el 90% de los mediabuyers.</li>
                <li>Una forma de estar constantemente en la mente de la gente y que nos compren todo lo que tenemos.</li>
                <li>Evitamos el error (que todo el mundo comete) que hace que aunque vendas más tu marca sea cada vez menos valiosa.</li>
                <li>Si nunca mandaste un mail a tu lista, no lo hagas. Primero tenemos que hacer una cosa.</li>
                <li>Lo que aprendí en el supermercado sobre cómo venderle más a la misma persona (aunque no quisiese comprar se verá atraído como polilla a la luz, y te lo agradecerá).</li>
                <li>Cómo vender más que tus competidores aunque vendas exactamente el mismo producto y sea hasta más caro.</li>
                <li>Si tienes familia hay algo que sabes que no debes hacer pero probablemente lo estás haciendo (le pasa a muchas tiendas).</li>
                <li>Cómo, dónde, cuándo, por qué y para qué usar los descuentos.</li>
              ...
              <h3 className="font-bold text-xl mt-8 mb-2">¿Qué incluye?</h3>
              <p className="mb-8">Todo. Es decir, te vamos a dar el planning para los próximos 3 meses, con las promociones, los mejores días para invertir más para tu tienda en concreto, un análisis de tus competidores y cómo diferenciarte (con creatividad) de ellos. Te vamos a dar varios dossieres con TODO, para que solo copies y pegues, y no te lleve más de 5 minutos implementar, y vamos a estar ahí para asegurarnos que lo haces y para analizarte los resultados y ayudarte a tomar las decisiones (o tomarlas por tí). Además donamos un 10% de lo que nos pagas a causas benéficas.</p>

              <h3 className="font-bold text-xl mt-8 mb-2">¿Cómo es el proceso de trabajo?</h3>
              <p className="mb-4">Se puede separar en 3 "fases". La primera es investigar a fondo, TODO, para que no seas un "más de lo mismo" (2 semanas). La segunda es implementar. Te damos los dossieres para que copies y pegues y te controlamos para que lo hagas. Y la tercera es el análisis de resultados. Semanalmente te analizamos todos los resultados y te compartimos un informes con los próximos pasos a seguir.</p>
              <p className="mb-8">Esto es así durante 3 meses. Luego, puedes renovar. Ahora, que nos hagas caso o no, depende de ti… pero cobrar, cobramos igual.</p>

              <h3 className="font-bold text-xl mt-8 mb-2">¿Si ya tengo equipo u otra agencia, me sirve?</h3>
              <p className="mb-8">Si, si tienes alguien que ejecute por ti, de puta madre, eso que te ahorras.</p>

              <h3 className="font-bold text-xl mt-8 mb-2">¿El servicio es para mi?</h3>
              ...
              <p className="mb-8">Nosotros queremos ser lo que te lleven de ahí a 100.000€ - 200.000€ - 500.000€ y más al MES.</p>

              <h3 className="font-bold text-xl mt-8 mb-2">¿Cuándo empezaremos?</h3>
              ...
              <p className="mb-4">Te va a costar más que cualquier consultora de esas de las promesas concretas, más que cualquier agencia de mierda y menos que las buenas agencias.</p>
              <p className="mb-4">No se puede pagar a plazos.</p>
              <p className="mb-8">Y respecto a la garantía, voy a tomar prestadas las palabras de un gran marketer: "Si me preguntas eso, la única garantía que te puedo dar es que no quiero trabajar contigo"</p>
