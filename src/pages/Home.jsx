              ...
              <div className="ml-form-checkboxRow ml-validate-required">
                <label className="checkbox">
                  ...
                  <div className="label-description">
                    <p>Acepto la <a href="https://antiagencia.es/PoliticaPrivacidad">política de privacidad</a></p>
                  </div>
                </label>
              </div>
...
export default function Home() {
  useEffect(() => {
    ...
    window.ml_webform_success_38376765 = function () {
      try { window.top.location.href = 'https://antiagencia.es/yaporfin'; }
      catch (e) { window.location.href = 'https://antiagencia.es/yaporfin'; }
    };
