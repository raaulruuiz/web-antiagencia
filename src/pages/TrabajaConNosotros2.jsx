        ...
        <div className="flex-1 flex justify-center px-4 py-12 md:py-20">
          <div className="w-full max-w-3xl">
            ...
            <Carta>
              ...
              <p>&nbsp;</p>
              <p>El caso es que en esta carta no encontrarás ningún vídeo de 4 minutos hablándote de lo bueno que soy, ni una oferta con garantía de resultados, ni un botón para agendar una llamada vestida de "asesoría" en la que intentaré lavarte el cerebro para que me compres. No.</p>
              <p>&nbsp;</p>
            ...
            <Carta>
              ...
              <p>Bien.</p>
              <p>&nbsp;</p>
              <p>Pues uno de esos veranos, con 15 o 16 años, estábamos quitando mamones a los tomates. El trabajo era sencillo. Entre el tallo principal y las hojas, los tomates crecen otros tallos, a los que se llama mamones, porque quitan agua y nutrientes al tallo principal, así que había que quitarlos mientras aún estaban pequeños.</p>
              <p>&nbsp;</p>
              ...
              <p>&nbsp;</p>
              <p>Después, en el descanso para comer. Mi madre, que es bastante más sutil que mi padre, me explicó que precisamente porque nosotros somos los jefes, somos los que tenemos que trabajar más duro.</p>
              <p>&nbsp;</p>
